# encoding: utf-8
"""
This is patched ver of /usr/lib/ckan/default/src/ckan/ckanext/multilingual/plugin.py from v2.7 of ckan
changes:
1. add zh_TW zh_CN in LANGS
2. comment out MultilinguaDataset.before_search
3. add title override at MultilingualDataset.before_view
"""
import ckan
...
LANGS = ['en', 'fr', 'de', 'es', 'it', 'nl', 'ro', 'pt', 'pl', 'zh_TW', 'zh_CN']
...
class MultilingualDataset(SingletonPlugin):
    ...
    def before_view(self, dataset_dict):
        ...
        dataset_dict = translate_data_dict(dataset_dict)
        title_translated = dataset_dict.get("title_"+desired_lang_code,"")
        if title_translated!="": dataset_dict["title"] = title_translated
        return dataset_dict
